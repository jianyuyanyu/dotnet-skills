...
LEGACY_DIRECT_REDIRECTS = {
    ...
    "skills/test-frameworks/": "skills/run-tests/",
...
def build_legacy_redirects(
    ...
    for source_slug, target_slug in {
        ...
        "test-frameworks": "run-tests",
        "exp-dotnet-test-frameworks": "run-tests",
